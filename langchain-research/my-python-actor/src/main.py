...
async def main():
    async with Actor:
        ...
        start_urls = actor_input.get('start_urls', [{ 'url': 'https://www.meetup.com/find/?source=EVENTS' }])
        ...
        async with async_playwright() as playwright:
            browser = await playwright.chromium.launch(headless=Actor.config.headless, executable_path="/root/.cache/ms-playwright/chromium-1060/chrome-linux/chrome")
            ...
            while request := await default_queue.fetch_next_request():
                ...
                try:
                    ...
                    Actor.log.debug(page)
                    Actor.log.debug(page.content())
